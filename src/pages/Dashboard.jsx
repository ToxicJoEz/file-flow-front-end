        ...
        <div className="flex justify-center min-h-screen mt-14">
          <div className="card">
                ...
                <defs>
                  ...
                  >
                    <g fillOpacity="0.6">
                      ...
                      <polygon fill="#47297B" points="360 0 270 150 450 150" />
                      <polygon fill="#8736AA" points="540 0 450 150 630 150" />
                      <polygon fill="#8736AA" points="900 0 810 150 990 150" />
                      <polygon fill="#47297B" points="0 300 -90 450 90 450" />
                      <polygon fill="#5D2689" points="0 300 90 150 -90 150" />
                      <polygon fill="#8736AA" points="180 300 90 450 270 450" />
                      <polygon fill="#47297B" points="180 300 270 150 90 150" />
                      <polygon
                        fill="#47297B"
                      ...
                      <polygon fill="#5D2689" points="180 600 90 750 270 750" />
                      <polygon fill="#47297B" points="180 600 270 450 90 450" />
                      <polygon
                        fill="#47297B"
                      ...
                      <polygon fill="#47297B" points="180 900 270 750 90 750" />
                      <polygon
                        fill="#8736AA"
            ...
            <div className="card__wrapper">
              <Link className="card__btn" to="/EditProfile">Edit Profile</Link>
            </div>
          </div>
        </div>
      ) : (
