...
export default function Terms() {
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-12 bg-white text-gray-800 rounded-lg shadow-lg mt-24">
      <h1 className="text-3xl md:text-4xl font-bold mb-4 text-[#47297B]">
        TERMS OF SERVICE
      </h1>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4 text-[#47297B]">
        AGREEMENT TO OUR LEGAL TERMS
      </h2>
      <p className="mb-4">
        We are FileFlow ("Company," "we," "us," "our"), a company registered in
        Saudi Arabia at 8819 abu yusuf, Dammam, Ar rakah ashamaliyah 34225.
      </p>
      <p className="mb-4">
        We operate the website https://file-flow.com (the "Site"), the mobile
        application FileFlow (the "App"), as well as any other related products
        and services that refer or link to these legal terms (the "Legal Terms")
        (collectively, the "Services").
      </p>
      <p className="mb-4">
        File Flow is a desktop file management application that helps users work
        with, analyze, and manage files and folders on their devices. The
        application currently focuses on advanced file searching across multiple
        files and folders, and may also include features such as file analysis,
        OCR, file unlocking, and file manipulation. File processing primarily
        occurs locally on the user’s device, while limited metadata and
        account-related information may be stored to support application
        functionality and improvement.
      </p>
      <p className="mb-4">
        You can contact us by email at fileflowco@gmail.com or by mail to 8819
        abu yusuf, Dammam, Ar rakah ashamaliyah 34225, Saudi Arabia.
      </p>
      <p className="mb-4">
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and FileFlow,
      ...
      <ol className="list-decimal pl-6 mb-8 space-y-1 text-blue-600 underline cursor-pointer">
        <li>
          <a href="#section-1">OUR SERVICES</a>
        </li>
        <li>
          <a href="#section-2">INTELLECTUAL PROPERTY RIGHTS</a>
        </li>
        <li>
          <a href="#section-3">USER REPRESENTATIONS</a>
        </li>
        <li>
          <a href="#section-4">USER REGISTRATION</a>
        </li>
        <li>
          <a href="#section-5">PURCHASES AND PAYMENT</a>
        </li>
        <li>
          <a href="#section-6">SUBSCRIPTIONS</a>
        </li>
        <li>
          <a href="#section-7">SOFTWARE</a>
        </li>
        <li>
          <a href="#section-8">PROHIBITED ACTIVITIES</a>
        </li>
        <li>
          <a href="#section-9">USER GENERATED CONTRIBUTIONS</a>
        </li>
        <li>
          <a href="#section-10">CONTRIBUTION LICENSE</a>
        </li>
        <li>
          <a href="#section-11">MOBILE APPLICATION LICENSE</a>
        </li>
        <li>
          <a href="#section-12">THIRD-PARTY WEBSITES AND CONTENT</a>
        </li>
        <li>
          <a href="#section-13">SERVICES MANAGEMENT</a>
        </li>
        <li>
          <a href="#section-14">PRIVACY POLICY</a>
        </li>
        <li>
          <a href="#section-15">TERM AND TERMINATION</a>
        </li>
        <li>
          <a href="#section-16">MODIFICATIONS AND INTERRUPTIONS</a>
        </li>
        <li>
          <a href="#section-17">GOVERNING LAW</a>
        </li>
        <li>
          <a href="#section-18">DISPUTE RESOLUTION</a>
        </li>
        <li>
          <a href="#section-19">CORRECTIONS</a>
        </li>
        <li>
          <a href="#section-20">DISCLAIMER</a>
        </li>
        <li>
          <a href="#section-21">LIMITATIONS OF LIABILITY</a>
        </li>
        <li>
          <a href="#section-22">INDEMNIFICATION</a>
        </li>
        <li>
          <a href="#section-23">USER DATA</a>
        </li>
        <li>
          <a href="#section-24">
        ...
        <li>
          <a href="#section-25">CALIFORNIA USERS AND RESIDENTS</a>
        </li>
        <li>
          <a href="#section-26">MISCELLANEOUS</a>
        </li>
        <li>
          <a href="#section-27">CONTACT US</a>
        </li>
      </ol>

      <div id="section-1" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          1. OUR SERVICES
        </h3>
        <p className="mb-4">
      ...
      <div id="section-2" className="mb-8">
        ...
        <p className="mb-4">
          ...
          please address your request to: fileflowco@gmail.com. If we ever grant
        ...
        <p className="mb-4">
          <span className="font-bold">Submissions:</span> By directly sending us
      ...
      <div id="section-7" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">7. SOFTWARE</h3>
        <p className="mb-4">
      ...
      <div id="section-8" className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            Using the Services to upload, process, or analyze files you do not
            own or have legal rights to
          </li>
          <li>
            Using the Services for illegal, harmful, or fraudulent purposes
          </li>
          <li>
            Attempting to reverse engineer, decompile, or tamper with the
            application
          </li>
          <li>
            Circumventing security features, usage limits, or access controls
          </li>
          <li>Using the Services to distribute malware or harmful code</li>
          <li>Abusing beta features or exploiting bugs for unintended use</li>
          <li>Interfering with or disrupting the Services or servers</li>
          <li>
            Using the Services in a way that could overload, stress, or damage
            the system
          </li>
          <li>
            Relying on the Services for critical, regulated, or safety-critical
            purposes
          </li>
        </ul>
      </div>
      ...
      <div id="section-11" className="mb-8">
        ...
        <h4 className="font-bold mt-4 mb-2">Apple and Android Devices</h4>
        <p className="mb-4">
      ...
      <div id="section-12" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
      ...
      <div id="section-13" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
      ...
      <div id="section-14" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          14. PRIVACY POLICY
        </h3>
        <p className="mb-4">
          ...
          Please be advised the Services are hosted in Saudi Arabia and Bahrain.
          ...
          disclosure that differ from applicable laws in Saudi Arabia and
          Bahrain, then through your continued use of the Services, you are
          transferring your data to Saudi Arabia and Bahrain, and you expressly
          consent to have your data transferred to and processed in Saudi Arabia
          and Bahrain.
        </p>
      </div>

      <div id="section-15" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
      ...
      <div id="section-16" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
      ...
      <div id="section-17" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          17. GOVERNING LAW
        </h3>
        <p className="mb-4">
          These Legal Terms shall be governed by and defined following the laws
          of Saudi Arabia. FileFlow and yourself irrevocably consent that the
          courts of Saudi Arabia shall have exclusive jurisdiction to resolve
          any dispute which may arise in connection with these Legal Terms.
        </p>
      </div>

      <div id="section-18" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          18. DISPUTE RESOLUTION
        </h3>
        <h4 className="font-bold mt-4 mb-2">Informal Negotiations</h4>
        <p className="mb-4">
        ...
        <h4 className="font-bold mt-4 mb-2">Binding Arbitration</h4>
        <p className="mb-4">
          ...
          be one (1). The seat, or legal place, or arbitration shall be dammam,
          Saudi Arabia. The language of the proceedings shall be english. The
          governing law of these Legal Terms shall be substantive law of Saudi
          Arabia.
        </p>
        <h4 className="font-bold mt-4 mb-2">Restrictions</h4>
        <p className="mb-4">
      ...
      <div id="section-19" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          19. CORRECTIONS
        </h3>
        <p className="mb-4">
      ...
      <div id="section-20" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          20. DISCLAIMER
        </h3>
        <p className="mb-4">
      ...
      <div id="section-21" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
        ...
        <p className="mb-4">
          ...
          OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO $50.00 USD.
      ...
      <div id="section-22" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          22. INDEMNIFICATION
        </h3>
        <p className="mb-4">
      ...
      <div id="section-23" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">23. USER DATA</h3>
        <p className="mb-4">
      ...
      <div id="section-24" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
      ...
      <div id="section-25" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
      ...
      <div id="section-26" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          26. MISCELLANEOUS
        </h3>
        <p className="mb-4">
      ...
      <div id="section-27" className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#47297B]">
          27. CONTACT US
        </h3>
        <p className="mb-4">
        ...
        <p className="mb-4 font-bold">
          ...
          8819 abu yusuf
          <br />
          Dammam, Ar rakah ashamaliyah 34225
          <br />
          Saudi Arabia
          <br />
          fileflowco@gmail.com
      ...
      <p className="text-sm text-gray-500 mt-8 border-t pt-4"></p>
    </div>
  );
}
