...
export default function PolicyAndTerms() {
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-12 bg-white text-gray-800 rounded-lg shadow-lg mt-24">
      ...
      <p className="mb-4">
        This Privacy Notice for FileFlow ("we," "us," or "our"), describes how
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          Visit our website at https://www.file-flow.com or any website of ours
          that links to this Privacy Notice
        </li>
        <li>
          Download and use our Desktop application (FileFlow), or any other
          application of ours that links to this Privacy Notice
        </li>
        <li>
          Use File Management system. File Flow is a desktop file management
          application that allows users to select local files and folders and
          search for specific words or phrases within those files. The
          application processes files locally on the user’s device and provides
          organized search results and related metadata. Additional features,
          such as optical character recognition (OCR), file unlocking, and file
          manipulation tools, may be added in future versions.
        </li>
        <li>
      ...
      <p className="mb-4 font-semibold">Questions or concerns?</p>
      <p className="mb-4">
        ...
        questions or concerns, please contact us at fileflowco@gmail.com.
      </p>
      ...
      <ol className="list-decimal pl-6 mb-8 space-y-1 text-blue-600 underline cursor-pointer">
        ...
        <li>
          <a href="#section-13">DO WE MAKE UPDATES TO THIS NOTICE?</a>
        </li>
        <li>
          <a href="#section-14">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>
        </li>
        <li>
          <a href="#section-15">
      ...
      <div id="section-1" className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            <span className="font-bold">Desktop Device Data.</span> We
            automatically collect device information (such as your Desktop
            ...
            hardware model, and Internet Protocol (IP) address (or proxy
            server). If you are using our application(s), we may also collect
            information network associated with your network provider, your
            desktop device’s operating system or platform, the type of desktop
            device you use, your desktop device’s unique device ID, and
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            <span className="font-bold">Log and Usage Data.</span> Log and usage
      ...
      <div id="section-2" className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            <span className="font-bold">To protect our Services.</span> We may
          ...
          <li>
            <span className="font-bold">To identify usage trends.</span> We may
      ...
      <div id="section-3" className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            <span className="font-bold">Performance of a Contract.</span> We may
          ...
          <li>
            <span className="font-bold">Legal Obligations.</span> We may process
          ...
          <li>
            <span className="font-bold">Vital Interests.</span> We may process
      ...
      <div id="section-5" className="mb-8">
        ...
        <h4 className="font-bold mt-4 mb-2">Our AI Products</h4>
        <p className="mb-2">
      ...
      <div id="section-6" className="mb-8">
        ...
        <p className="mb-4">
          Our servers are located inBahrain. Regardless of your location, please
          ...
          including facilities in Bahrain, and other countries.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          implemented measures to protect your personal information, including
          ...
          protection laws and regulations. Our Standard Contractual Clauses can
          be provided upon request. We have implemented similar appropriate
      ...
      <div id="section-10" className="mb-8">
        ...
        <p className="mb-4">
          ...
          processing of your personal information. You can make such a request
        ...
        <h4 className="font-bold mt-4 mb-2">Account Information</h4>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          email us at fileflowco@gmail.com.
        </p>
      </div>
      ...
      <div id="section-12" className="mb-8">
        ...
        <p className="mb-4">
          <span className="font-bold">Sources of Personal Information</span>{" "}
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <span className="font-bold">Right to know</span> whether or not we
            are processing your personal data
          </li>
          <li>
            <span className="font-bold">Right to access</span> your personal
            data
          </li>
          <li>
            <span className="font-bold">Right to correct</span> inaccuracies in
            your personal data
          </li>
          <li>
            <span className="font-bold">Right to request</span> the deletion of
            your personal data
          </li>
          <li>
            <span className="font-bold">Right to obtain a copy</span> of the
            personal data you previously shared with us
          </li>
          <li>
            <span className="font-bold">Right to non-discrimination</span> for
            exercising your rights
          </li>
          <li>
            <span className="font-bold">Right to opt out</span> of the
        ...
        <h4 className="font-bold mt-4 mb-2">How to Exercise Your Rights</h4>
        <p className="mb-4">
          To exercise these rights, you can contact us by submitting a data
          subject access request, by emailing us at fileflowco@gmail.com, or by
        ...
        <h4 className="font-bold mt-4 mb-2">Request Verification</h4>
        <p className="mb-4">
        ...
        <h4 className="font-bold mt-4 mb-2">Appeals</h4>
        <p className="mb-4">
          Under certain US state data protection laws, if we decline to take
          action regarding your request, you may appeal our decision by emailing
          us at fileflowco@gmail.com. We will inform you in writing of any
      ...
      <div id="section-14" className="mb-8">
        ...
        <p className="mb-4">
          ...
          at fileflowco@gmail.com or contact us by post at:
        </p>
